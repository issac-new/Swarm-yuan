...
> **门禁分层（决策 19）：** 44 门禁按 `fail()` 能力分三档，与 core/standard/compliance 三档正交（横切维度）：
...
**自举：** swarm-yuan 能用自身的 44 个门禁检查自身。一个连自己都检查不了的工具，凭什么检查你的项目？
...
│   │   ├── precheck.sh           ← 44 个门禁（3800+ 行，随门禁扩展演进）
