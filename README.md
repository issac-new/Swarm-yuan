...
[![Release](https://img.shields.io/badge/release-v1.9-blue)](https://github.com/issac-new/Swarm-yuan/releases/tag/v1.9)
...
📖 完整发版说明（设计取舍 / 门禁示例 / 质量基线）：见 [v1.0 Release Notes](https://github.com/issac-new/Swarm-yuan/releases/tag/v1.9)
