...
## 设计与决策弧线（v2026.07.04 → v2026.07.25）
...
| **质量门禁** | **54 个** = strict 17 + warn 21 + advisory 16（执法强度横切）；执行序列 --all 核心 10 / --all-full 标准 27 / --compliance-suite 合规 17 / advisory-only 5 不在任何执行序列 | FACT_GATES_TOTAL=54 |
