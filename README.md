...
[![Release](https://img.shields.io/badge/release-v2026.07.17-blue)](https://github.com/issac-new/Swarm-yuan/releases/tag/v2026.07.17)
...
### 架构门禁（`--all-full`，15 个，~30 秒，未配置则静默跳过）
