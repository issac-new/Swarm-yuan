...
同步基线：2026-07-19（当时门禁 27 个 + 公共库 `_fw_report`/`_fw_strip_comments_*`，该批口径为 31 门禁；现行口径 36 门禁见上方「数字一览」；记录于 `Swarm-studio/.swarm-yuan-version` 与 `verifier/runs/2026-07-19T1741-swarm-studio-resync.log`）。
