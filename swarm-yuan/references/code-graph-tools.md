...
- **graphify 引用基线：v0.9.x**（本文能力清单基于 v0.9.5 源码调研 + v0.9.6–v0.9.19 release notes）。上游已发布 **0.10.0**（npm graphifyy，2026-07-20 实测；PyPI 仍 0.9.20），**0.10.0 待评估**，评估前不引用其新能力（登记见 README.md §7.4 上游运行时基线）。
