# spring-cloud fixture 说明

- violating 主触发 1 个 fail 意图：
  - fw_scloud_config_encrypt —— 配置中心敏感 key 值非 {cipher} 前缀 → fail 明文泄露 (CWE-312)。
...
- 验收：`bash swarm-yuan/tests/run-framework-fixture.sh spring-cloud` 双态绿（violating 检出 / compliant PASS）。
