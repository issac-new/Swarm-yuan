# opentelemetry fixture 说明

- violating 主触发 1 个 fail 意图：
  - fw_opentelemetry_deprecated_exporter —— 命中 Jaeger/Zipkin exporter → fail。
...
- 验收：`bash swarm-yuan/tests/run-framework-fixture.sh opentelemetry` 双态绿（violating 检出 / compliant PASS）。
