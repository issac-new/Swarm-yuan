...
- violating 主触发 1 个 fail 意图：
  - fw_rabbitmq_manual_ack —— 检出 AcknowledgeMode.NONE / acknowledge-mode: none / basicConsume(...,true) → f...。
...
- 验收：`bash swarm-yuan/tests/run-framework-fixture.sh rabbitmq` 双态绿（violating 检出 / compliant PASS）。
