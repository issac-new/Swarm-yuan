# spring-data-jpa fixture 说明

- violating 主触发 1 个 fail 意图：
  - fw_jpa_enum_ordinal —— @Enumerated 未带 EnumType.STRING → fail（ORDINAL 重排错位）(n/a)。
...
- 验收：`bash swarm-yuan/tests/run-framework-fixture.sh spring-data-jpa` 双态绿（violating 检出 / compliant PASS）。
