...
# 按序探测候选路径（支持 glob，如 ".agents/skills/*/x.md"），回显第一个存在的文件；均无则输出空
...
check_reuse() {
  ...
  # 兜底候选含 glob：.agents/skills/<*>/references/reference-manual.md
  local ref_file
  ref_file=$(_first_existing_file "references/reference-manual.md" "reference-manual.md" ".agents/skills/*/references/reference-manual.md")
...
check_cognition() {
  ...
  local rm_file
  rm_file=$(_first_existing_file "references/reference-manual.md" "reference-manual.md" ".agents/skills/*/references/reference-manual.md")
  if [[ -n "$rm_file" ]]; then
...
check_knowledge() {
  ...
  local skill_file
  skill_file=$(_first_existing_file "$PROJECT_DIR/.agents/skills/*/SKILL.md" ".agents/skills/*/SKILL.md" "SKILL.md")
